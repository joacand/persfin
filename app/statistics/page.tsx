...
export default function Statistics() {
    ...
    return (
        <Base>
            ...
            <div className="w-full h-[50vh] bg-[#1B2227] rounded">
                {projection.graphData?.length > 0 &&
                    <ResponsiveContainer width="100%" height="100%" initialDimension={{ width: 220, height: 100 }}>
